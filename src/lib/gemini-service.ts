// Google Gemini Problem Generation Service
...
// Generate a new programming problem using Gemini
...
Return ONLY the JSON object with no extra text.`;
    ...
    const problem = JSON.parse(text) as GeneratedProblem;
    ...
    throw new Error('Failed to generate problem with Gemini');
  }
}
